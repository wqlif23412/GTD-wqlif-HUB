...
function AutoFarm:StopEverything()
    ...
    local function startAutoGame(speed)
        ...
        -- Времена размещения с компенсацией
        -- Игра длится 2:44 (164 секунды) - увеличен на 27 секунд
        local placements = {
        ...
        local gameDuration = 164  -- 2:44 = 164 секунды (увеличен на 27 секунд)

        -- Основной игровой цикл
        while AutoFarm.running do
            print("[ЦИКЛ] Начало нового цикла игры...")
            
            -- Проверяем, не остановлена ли игра
            if not AutoFarm.running then
                print("[ЦИКЛ] Игра остановлена, прерываем цикл")
                break
            end
            ...
            -- Ждем 6 секунд для компенсации задержки
            ...
            print("[ЦИКЛ] Начинаем размещение юнитов:")
            print("  • Немедленно: Юнит 1 (будет на 2 секунде игры)")
            print("  • 6 секунд: Юнит 2 (будет на 11 секунде игры)")
            print("  • 14 секунд: Юнит 3 (будет на 19 секунде игры)")
            print("  • 23 секунды: Юнит 4 (будет на 28 секунде игры)")
            
            -- Проверяем перед каждым действием
            if not AutoFarm.running then
                print("[ЦИКЛ] Игра остановлена перед размещением")
                break
            end
            ...
            local timeToWait = gameDuration - placements[4].targetTime
            
            if timeToWait > 0 then
                print("[ЦИКЛ] Ожидание конца игры: " .. timeToWait .. " секунд")
    ...
    local function main()
        ...
        print("==========================================")
        print("Времена размещения (секунды игры):")
        print("• 2 секунды - Юнит 1")
        print("• 11 секунд - Юнит 2")
        print("• 19 секунд - Юнит 3")
        print("• 28 секунд - Юнит 4")
        print("")
        print("Длительность игры: 2:44 (164 секунды)") -- Увеличена на 27 секунд
        print("Время ожидания после 4-го юнита: 136 секунд")
        print("")
        print("Управление:")
